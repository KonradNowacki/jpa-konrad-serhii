...
values (901, 'ul. Przykładowa 1', 'mieszkanie 1', 'Warszawa', '00-001');

insert into address (id, address_line1, address_line2, city, postal_code)
values (902, 'ul. Słoneczna 10', 'blok 5', 'Kraków', '30-001');

insert into address (id, address_line1, address_line2, city, postal_code)
values (903, 'ul. Leśna 5', 'apartament 2', 'Gdańsk', '80-001');

insert into address (id, address_line1, address_line2, city, postal_code)
values (904, 'ul. Polna 3', 'dom 1', 'Wrocław', '50-001');

insert into address (id, address_line1, address_line2, city, postal_code)
values (905, 'ul. Mickiewicza 8', 'mieszkanie 3', 'Poznań', '60-001');
